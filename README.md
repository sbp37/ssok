...
- **광고 전환 정책**: 일반 NEXT는 첫 완료 면제 + 최소 2분 간격의 전면광고 후보, 희귀 변종은 선택형 보상광고. 보상형 종료 후 다음 일반 전환은 면제. 준비/실행 실패 시 일반 진행. 현재 SDK 미연결로 전면광고는 표시하지 않으며 보상형은 기존 모의 성공이다. [정책·어댑터 계약·운영 실험](docs/ad-policy.md).
